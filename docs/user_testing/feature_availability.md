...
| Meta 分析 | AI-assisted Review | 测试中 | 支持 testing AI suggestion queue；AI 只生成候选建议，必须人工 accept / reject / edit，并且 accepted 后还需要明确 apply。AI 不会直接覆盖正式 screening、extraction、analysis 或 report 数据。 | 继续接入受控本地/外部 AI provider，并完善人工审核 UX。 |
