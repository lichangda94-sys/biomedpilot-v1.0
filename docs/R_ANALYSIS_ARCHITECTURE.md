...
| Architecture gate script | Present; `scripts/analysis_architecture_gate.py` emits a schema-checked read-only JSON gate for P0/contract validity and can optionally require full readiness. |
