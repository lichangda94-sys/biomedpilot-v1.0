...
- Added pending detailed result view inventory to the frontend consumption matrix so RARCH-08 names the remaining module-specific UI consumers instead of only reporting a generic warning.
