...
- created_at: `2026-06-02T14:19:06.557047+00:00`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Bioinformatics | 12 | 219 | 158 | 61 | 0 | 1 | 11 | 0 | 0 |
| Centers | 1 | 28 | 23 | 5 | 0 | 0 | 1 | 0 | 0 |
| LabTools | 4 | 159 | 144 | 15 | 0 | 3 | 1 | 0 | 0 |
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| `docs/project-control/UI_ROUTE_CONTRACT_BIO_BATCH1.json` | Bioinformatics | `13128f797492` | `current-head-proof` | 27 | 22 | 5 | 0 | - |
...
| `docs/project-control/UI_ROUTE_CONTRACT_LABTOOLS_BATCH2.json` | LabTools | `13128f797492` | `current-head-proof` | 21 | 18 | 3 | 0 | - |
...
| `docs/project-control/UI_ROUTE_CONTRACT_LABTOOLS_BATCH4_PROTEIN_WB.json` | LabTools | `13128f797492` | `current-head-proof` | 83 | 82 | 1 | 0 | - |
| `docs/project-control/UI_ROUTE_CONTRACT_LABTOOLS_BATCH5_SECONDARY_REMAINDER.json` | LabTools | `13128f797492` | `current-head-proof` | 11 | 6 | 5 | 0 | - |
...
| `docs/project-control/UI_ROUTE_CONTRACT_PHASE1_BATCH0.json` | Centers, Shell | `3ee1ee212b87` | `prior-proof-docs-only-head-drift` | 28 | 23 | 5 | 0 | - |
