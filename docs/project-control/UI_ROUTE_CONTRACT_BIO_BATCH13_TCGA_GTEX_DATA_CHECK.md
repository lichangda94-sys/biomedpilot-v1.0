...
| BIO-B13-DATA-CHECK-RUN-RECOGNITION-TCGA-GTEX | data_check_preparation | `bioinformaticsRunRecognitionButton` | connected | app.bioinformatics.project_recognition.run_project_recognition_for_paths | logs/recognition/recognition_report.json; recognized_data/current.json; logs/recognition/group_preview_report.json; selected_input_count=8 |
