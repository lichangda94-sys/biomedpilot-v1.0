...
if QWidget is not None:
    ...
    class LabToolsWorkspaceWidget(QWidget):
        ...
        def _build_ui(self) -> None:
            ...
            home.setProperty("buttonBehavior", "navigates_to_labtools_home")
            home.setProperty("formalActionEnabled", False)
            home.setProperty("fileWriteAllowed", False)
            ...
            if self._on_back is not None:
                ...
                back.setProperty("buttonBehavior", "navigates_to_shell_route_dashboard")
                back.setProperty("formalActionEnabled", False)
                back.setProperty("fileWriteAllowed", False)
