...
if QWidget is not None:
    ...
    class WesternBlotLoadingCalculatorWidget(QWidget):
        ...
        def _build_sample_card(self) -> QFrame:
            ...
            self._add_sample_button.setProperty("buttonBehavior", "adds_protein_loading_sample_row")
            self._add_sample_button.setProperty("formalActionEnabled", False)
        ...
        def _build_action_card(self) -> QFrame:
            ...
            self._calculate_button.setProperty("buttonBehavior", "calculates_protein_loading_plan")
            self._calculate_button.setProperty("formalActionEnabled", False)
            ...
            self._copy_button.setProperty("buttonBehavior", "copies_protein_loading_markdown_when_available")
            self._copy_button.setProperty("disabledReason", "Requires a generated protein loading calculation before copy is enabled.")
