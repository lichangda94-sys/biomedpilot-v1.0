...
REPAIR_GUIDANCE = {
    ...
    "missing_case_or_sample_identifier": "Add a case_id, sample_id, patient_id, TCGA barcode, or GEO accession column.",
    "case_sample_mapping_failed": "Repair clinical-to-expression case/sample mapping before survival preflight.",
    "no_overlap_between_clinical_and_expression": "Clinical cases and expression samples do not overlap.",
    "duplicate_case_id_unresolved": "Resolve duplicate clinical case ids before survival preflight.",
    "duplicate_sample_id_unresolved": "Resolve duplicate sample ids before survival preflight.",
    "ambiguous_many_to_many_mapping": "Resolve many-to-many case/sample mapping before survival preflight.",
    "missing_time_field": "Select or derive an OS_time / survival time field.",
    "missing_event_field": "Select or derive an OS_event / vital status field.",
    "ambiguous_event_coding": "Confirm event coding before KM/log-rank/Cox can be considered.",
    "negative_survival_time": "Fix negative survival times.",
    "no_events": "At least one observed event is required for future survival statistics.",
    "all_time_missing": "Survival time is missing for all rows.",
    "all_event_missing": "Survival event is missing for all rows.",
    "identifier_not_allowed_for_statistics": "Identifier columns are excluded from formal statistics.",
    "unknown_variable_type": "Confirm or transform unknown clinical variable types.",
    ...
    "lifelines_missing_formal_survival_disabled": "Survival remains preflight-only; no KM/Cox/log-rank execution.",
