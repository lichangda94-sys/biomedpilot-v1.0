...
PLOT_TYPES = {"volcano_plot", "deg_heatmap", "ora_barplot", "ora_dotplot", "gsea_enrichment_curve_spec", "gsea_nes_barplot_spec", "correlation_scatter", "km_plot", "km_curve", "cox_forest_plot"}
