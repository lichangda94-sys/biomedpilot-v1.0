...
def _capability_matrix(entries: list[dict[str, Any]], analysis_state: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    rows = [
        ...
        ("Controlled ORA from formal DEG", "implemented_and_gated", _has(entries, "ora_enrichment", "formal_computed_result"), "formal DEG result index", "formal_computed_result", "ORA SVG plot artifact", "ORA report package", "run_ora_enrichment"),
        ...
        ("Controlled preranked GSEA from formal DEG", "implemented_and_gated", _has(entries, "gsea_preranked", "formal_computed_result"), "formal DEG result index/rank metric", "formal_computed_result", "GSEA SVG plot artifact", "GSEA report package", "formal_gsea"),
        ...
        ("ORA SVG plot artifact", "implemented_real_svg", _has_plot(entries, "ora_plot_spec"), "ORA result table", "inherits source", "builtin SVG renderer; no external dependency", "does not auto report-ready", "ora_plot"),
        ("GSEA SVG plot artifact", "implemented_real_svg", _has_plot(entries, "gsea_plot_spec"), "GSEA result table", "inherits source", "builtin SVG renderer; no external dependency", "does not auto report-ready", "gsea_plot"),
