...
def validate_analysis_resource_manifest(
    ...
    *,
    ...
    return {
        ...
        "expected_resource_ids": evidence_registry_validation.get("expected_resource_ids", []),
        "missing_resource_ids": evidence_registry_validation.get("missing_resource_ids", []),
        "missing_resource_count": evidence_registry_validation.get("missing_count", 0),
        "blockers": blockers,
        "warnings": warnings,
    }
...
def validate_analysis_environment_registry(
    ...
    *,
    ...
    return {
        ...
        "evidence_registry_status": evidence_registry_validation.get("status"),
        "evidence_registry_entry_count": evidence_registry_validation.get("entry_count"),
        "expected_environment_ids": evidence_registry_validation.get("expected_environment_ids", []),
        "missing_environment_ids": evidence_registry_validation.get("missing_environment_ids", []),
        "missing_environment_count": evidence_registry_validation.get("missing_count", 0),
        "blockers": list(dict.fromkeys(blockers)),
