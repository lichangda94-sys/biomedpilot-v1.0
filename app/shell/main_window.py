...
class MainWindow(QMainWindow):
    def __init__(self, dashboard: DashboardModel | None = None) -> None:
        ...
        self._labtools_page.setProperty("moduleKey", ModuleKey.LABTOOLS.value)
        self._labtools_page.setProperty("pageKey", "home")
        self._labtools_page.setProperty("semanticKey", PageKey.LABTOOLS_HOME.value)
        self._labtools_page.setAccessibleName("LabTools workspace")
        self._labtools_legacy_shell_page = self._build_labtools_page()
        self._labtools_legacy_shell_page.setParent(self._labtools_page)
        self._labtools_legacy_shell_page.hide()
