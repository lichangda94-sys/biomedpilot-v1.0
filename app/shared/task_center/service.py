...
class TaskType(StrEnum):
    ...
    SUBGROUP_ANALYSIS_RUN = "subgroup_analysis_run"
    LEAVE_ONE_OUT_RUN = "leave_one_out_run"
    PUBLICATION_BIAS_TEST = "publication_bias_test"
    FOREST_PLOT_EXPORT = "forest_plot_export"
    FUNNEL_PLOT_EXPORT = "funnel_plot_export"
    ...
    WORD_REPORT_EXPORT = "word_report_export"
    HTML_REPORT_EXPORT = "html_report_export"
    PDF_REPORT_EXPORT = "pdf_report_export"
    SUPPLEMENTARY_EXPORT = "supplementary_export"
    FIGURE_PACKAGE_EXPORT = "figure_package_export"
    PROJECT_SNAPSHOT_CREATE = "project_snapshot_create"
    REPRODUCIBILITY_PACKAGE_EXPORT = "reproducibility_package_export"
    ...
    ATTACHMENT_VALIDATE = "attachment_validate"
    MISSING_FULLTEXT_REPORT_EXPORT = "missing_fulltext_report_export"
