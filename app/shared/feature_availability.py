...
FEATURE_REGISTRY: tuple[FeatureAvailability, ...] = (
    ...
    FeatureAvailability("meta_analysis", "meta-reporting", "Reporting", FeatureAvailabilityStatus.TESTING, "保留 Analysis 预检测试版 Markdown 摘要，并支持 testing PRISMA 数字摘要和 formal Markdown report 雏形；Word/PDF 正式报告尚未开放。", "接入 full-text、质量评价和 publication export。", "app/meta_analysis/legacy/reporting"),
