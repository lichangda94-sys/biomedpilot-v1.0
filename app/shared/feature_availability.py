...
FEATURE_REGISTRY: tuple[FeatureAvailability, ...] = (
    ...
    FeatureAvailability("meta_analysis", "meta-extraction", "Extraction", FeatureAvailabilityStatus.TESTING, "读取 Screening 队列并为 included 文献生成数据提取池；已新增结构化 ExtractionRecord core，正式人工提取表单尚未开放。", "接入 Extraction 表单、CSV 导出和 Analysis-ready dataset 构建。", "app/meta_analysis/legacy/extraction"),
