...
FEATURE_REGISTRY: tuple[FeatureAvailability, ...] = (
    ...
    FeatureAvailability("meta_analysis", "meta-analysis", "Analysis", FeatureAvailabilityStatus.TESTING, "读取 Extraction 输出并执行 Analysis 预检，可构建 analysis-ready dataset，并支持基础 testing pooled effect；当前不是生产级正式 Meta 统计。", "接入森林图、结果表和图表导出。", "app/meta_analysis/legacy/analysis"),
