...
FEATURE_REGISTRY: tuple[FeatureAvailability, ...] = (
    ...
    FeatureAvailability("meta_analysis", "meta-analysis", "Analysis", FeatureAvailabilityStatus.TESTING, "读取 Extraction 输出并执行 Analysis 预检，并可从结构化 extraction_records 构建 analysis-ready dataset；当前不运行正式 Meta 统计。", "接入基础 Meta 统计 runner。", "app/meta_analysis/legacy/analysis"),
