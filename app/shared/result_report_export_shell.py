...
def make_result_report_export_adoption_panel(
    *,
    ...
    frame.setStyleSheet("QFrame#resultReportExportAdoptionPanel { border: 1px solid #D6E0EA; border-radius: 8px; background: #FFFFFF; }")
...
def _make_result_report_export_marker(resource_id: str, label: str, shell_state: ResultReportExportState):
    ...
    marker.setStyleSheet(
        ...
        "border: 1px solid #D6E0EA; border-radius: 6px; background: #F8FAFC; "
        "}"
    )
